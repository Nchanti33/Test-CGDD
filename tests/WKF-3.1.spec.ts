...
test(name, async ({ page }) => {
  ...
  await page.getByRole('option', { name: 'Carte communale' }).click();
  ...
  await page.getByLabel('3.2.1').getByText('Non').click();
  await page.getByLabel('3.2.4').getByText('Non').click();
  await page.getByRole('button', { name: '4.' }).click();
  await page.locator('.choices > .form-control.ui').nth(4).click();
  await page.getByRole('option', { name: 'élaboration (article L. 163-4 du code de l’urbanisme)' }).click();
  ...
  await page.getByLabel('Les dispositions de la loi montagne').getByText('Non').first().click();
  await page.getByLabel('Les dispositions de la loi littoral').getByText('Non').first().click();
  await page.getByLabel('Un site désigné Natura 2000 en application de l\'article L. 414-1 du code de l\'environnement (ZICO, ZPS, ZSC)').getByText('Non').first().click();
  await page.getByLabel('Un cœur de parc national délimité en application de l\'article L. 331-2 du code de l\'environnement').getByText('Non').first().click();
  await page.getByLabel('Une réserve naturelle ou un périmètre de protection autour d’une réserve institués en application, respectivement, des articles L. 332-1 et L. 332-16 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un site inscrit ou classé en application des articles L. 341-1 et L. 341-2 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un plan de prévention des risques technologiques prévu à l’article L. 515-15 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un plan de prévention des risques naturels prévisibles prévu à L. 562-1 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un périmètre des servitudes relatives aux installations classées pour la protection de l\'environnement instituées en application de l’article L. 515-8 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un périmètre des servitudes sur des terrains pollués, sur l\'emprise des sites de stockage de déchets, sur l\'emprise d\'anciennes carrières ou dans le voisinage d\'un site de stockage géologique de dioxyde de carbone instituées en application de l’article L. 515-12 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un plan de prévention des risques miniers prévus à l’article L. 174-5 du code minier').getByText('Non').first().click();
  await page.getByLabel('Un site patrimonial remarquable créé en application des articles L. 631-1 et L. 632-2 du code du patrimoine').getByText('Non').first().click();
  await page.getByLabel('Des abords des monuments historiques prévus aux articles L. 621-30 et L. 621-31 du code du patrimoine').getByText('Non').first().click();
  await page.getByLabel('Une zone humide prévue à l’article L. 211-1 du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Une trame verte et bleue prévue à l’article L. 371-1 du code de l’environnement (préciser réservoir de biodiversité et/ou corridor écologique)').getByText('Non').first().click();
  await page.getByLabel('Une ZNIEFF (préciser type I ou II) prévue à l’article L. 411-1 A du code de l’environnement').getByText('Non').first().click();
  await page.getByLabel('Un espace naturel sensible prévu à l’article L. 113-8 du code de l’urbanisme').getByText('Non').first().click();
  await page.getByLabel('Un espace concerné par : - un arrêté de protection de biotope prévu à l’article R. 411-15 du code de l’environnement ; - un arrêté le listant comme un site d\'intérêt géologique prévu à l’article R. 411-17-1 du même code ; - un arrêté le listant comme une zone prioritaire pour la biodiversité prévue à l’article R. 411-17-3 du même code').getByText('Non').first().click();
  await page.getByLabel('Un espace boisé classé prévu à l’article L. 113-1 du code de l’urbanisme, une forêt de protection prévue à l’article L. 141-1 du code forestier').getByText('Non').first().click();
  ...
  await page.getByLabel('Un espace concerné par : - un arrêté de protection de biotope prévu à l’article R. 411-15 du code de l’environnement ; - un arrêté le listant comme un site d\'intérêt géologique prévu à l’article R. 411-17-1 du même code ; - un arrêté le listant comme une zone prioritaire pour la biodiversité prévue à l’article R. 411-17-3 du même code').getByText('Non').last().click();
  ...
  await page.getByLabel('7.3.1').getByText('Non').click();
  await page.getByLabel('7.3.2').getByText('Non').click();
  await page.getByLabel('7.3.3').getByText('Non').click();
  await page.getByRole('textbox', { name: '7.3.5' }).click();
  await page.getByRole('textbox', { name: '7.3.5' }).fill('a');
